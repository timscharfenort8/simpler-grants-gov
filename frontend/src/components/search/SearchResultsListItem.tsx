...
export default function SearchResultsListItem({
  ...
  const [loadingOpportunity, setLoadingOpportunity] = useState<boolean>(false);
      ...
      <div className="desktop:grid-col-fill">
        <div className="grid-row flex-column">
          <div className="grid-col tablet:order-2">
            <h2
              className="margin-y-105 line-height-serif-2"
              onClick={() => setLoadingOpportunity(true)}
            >
              <Link
  ...
  return (
    <div className={resultBorderClasses}>
      {loadingOpportunity ? <Loading /> : <Display />}
    </div>
  );
}
